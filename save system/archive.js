...
function showBlackout(callback) {
    ...
    // Wait for the fade-in transition to complete before executing the callback
    setTimeout(callback, 1000); // Match this duration with the fade-in transition
}
...
function override(id) {
    ...
    // Show blackout and then redirect
    showBlackout(() => {
